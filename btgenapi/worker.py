...
from btgenapi.parameters import GenerationFinishReason, ImageGenerationResult, clue, default_prompt1, words
...
def process_generate(async_task: QueueTask):
    ...
    try:
        ...
        prompt = words + params.prompt + clue
        ...
        if not skip_prompt_processing:
            ...
            negative_prompts = remove_empty_str([safe_str(p) for p in prompt1.splitlines()], default='')

            prompt = prompts[0]
            prompt1 = negative_prompts[0]
            ...
            for i in range(image_number):
                ...
                task_negative_prompt = apply_wildcards(prompt1, task_rng)

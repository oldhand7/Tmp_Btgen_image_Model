...
words = "woman in image prompts with various,  suitable elegant color and style of clothes for "
default_prompt1 = ['Two-piece', 'Bikini briefs', 'Monokini', 'Tankini', 'Triangle bikini', 'Bandeau bikini', 'Halter-neck bikini', 'High-waisted bikini', 'naked', 'naked', 'bachelorette', 'underwearing', 'underweared', 'nuke', 'nudity', 'bachelor', 'bottomless', 'underwear', 'bikini', 'bikini', 'bikini', 'bikini', 'bikini', 'bikini', 'topless', 'underwearing', 'underweared', 'underwearing', 'underweared', 'sexy', 'around current clothing', '']
...
clue = ', on a full-length body , separate from image prompt selfies and irrespective of image prompt'
